...
contract TimeLock {
    ...
    constructor(address _toContract) {
    ...
    function addToQueue(string calldata func, string calldata data, uint value) public payable returns(bytes32) {
    ...
    function execute(bytes32 txId) public payable returns(bytes memory) {
